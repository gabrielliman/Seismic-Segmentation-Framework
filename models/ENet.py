...
from keras.layers import SpatialDropout2D,Input, Conv2D, MaxPooling2D, Conv2DTranspose, concatenate, UpSampling2D, BatchNormalization, Activation, Permute,ZeroPadding2D,Add
